...
function SelectComponent(props) {
    const { title, values, value, onChange, onFocus, className, id, ...rest } = props;
    return (_jsxs(Select, { value: value, onValueChange: onChange, children: [_jsx(SelectTrigger, { id: id, className: className, onFocus: onFocus, ...rest, children: _jsx(SelectValue, { placeholder: title }) }), _jsx(SelectContent, { children: _jsx(SelectGroup, { children: values.map(option => (_jsx(SelectItem, { value: option.value, children: option.label }, option.value))) }) })] }));
}
